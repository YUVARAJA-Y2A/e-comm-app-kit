...
import "./styles/feature_products.css";

function Featured_Products() {
  return (
    <div>
      <p class="featured-products-title">FEATURED PRODUCTS</p>
      <div class="d-flex justify-content-evenly product-lists">
        <div class="d-flex">
          <div class="shoe-img"></div>
          <div class="ps-4">
            <p class="shoe-name">Blue Swade Nike Sneakers</p>
            <svg
              width="125"
              height="16"
              viewBox="0 0 125 16"
            ...
            <div class="d-flex pt-3">
              <p class="shoe-price-disc">$499</p>
              <p class="shoe-price-org px-2">$599</p>
            </div>
          </div>
        </div>
        <div class="d-flex">
